...
import {statsTemplate, renderIntro} from './stats.js';
...
const renderStats = () => {
  ...
  const game3Controls = Array.from(document.querySelectorAll(`.game__option`));
...
export {game3Template, renderStats};
