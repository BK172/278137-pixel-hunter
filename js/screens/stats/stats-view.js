...
export default class StatsView extends AbstractView {
  constructor(state) {
    super();
    this.state = state;
    this._score = getScore(this.state.answers, this.state.lives);
    this._scoreCount = getScoreCount(this.state.answers);
    this._correctLives = this.state.lives === -1 ? 0 : this.state.lives;
  }
